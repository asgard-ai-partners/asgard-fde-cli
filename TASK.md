...
| `root-documents` Goal, AGENTS, APPROACH, STRUCTURE, README - the files that state the rules, as opposed to the paths and commands in them | all five read end to end against the binary, the tree and the CRDs. AGENTS' twelve questions and four contradictions are the part still held against nothing but the failures they each cite | 2026-09-14 |
