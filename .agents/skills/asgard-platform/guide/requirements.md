...
before they start:
    ...
    asgard-cli question add "<what blocks it>" --blocks <request-id> --ask "<who>"
...
meeting. A question with no owner is not tracked, it is just written down.

## When the request is ready

`asgard-cli request ready <request-id>` when all of these hold:
...
Then split it into task specs:
    ...
    asgard-cli task add "<title>" --request <request-id> --project <project> --complexity M
